...
export default function SearchBar({callback}) {
    ...
    return (
        ...
        <GooglePlacesAutocomplete
            ...
            query={{
                key: 'AIzaSyDjclgkpjQOQoMiACyWaoqpLIglE73RmdE',
                language: 'en',
            }}
            ...
            //     url:
            //       'https://cors-anywhere.herokuapp.com/', // or any proxy server that hits https://maps.googleapis.com/maps/api
            //     headers: {
